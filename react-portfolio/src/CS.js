...
function CS() {
  ...
  let compText;
  if(windowMode === 0){
    b2nText = "Books2Nooks takes a user inputted book and generates a music playlist. \
    ...
    aaText = "Authorship Attribution is the task of guessing the author of an anonymous article. We trained our \
    ...
    compText = "I perform image compression using Singular Value Decomposition (SVD) as well as Gaussian Mixture Modeling (GMM). \
    ...
    b2nText = "Books2Nooks takes an inputted book and generates a playlist."
    aaText = "Authorship Attribution is the task of guessing the author of an anonymous article."
    compText = "I perform image compression using SVD and GMM."
    ...
    compText = "I perform image compression using Singular Value Decomposition (SVD) and Gaussian Mixture Modeling (GMM). \
  ...
  return (
    <div className="CS" style = {windowMode === 3 ? {margin: 15}:{margin:60}}>
